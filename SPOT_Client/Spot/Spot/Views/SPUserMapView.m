...
-(void)onViewMoveToNextCellFinished:(SnapImageDirection)direction
{
    ...
    NSString* userMapURL = [[NSString alloc] initWithFormat:URL_USERMAP,self.spotInfo.spotID];
    [[RHProtocolSender getInstance] getJSONFromURL:[NSURL URLWithString:userMapURL] WithJSON:appendDic Success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
